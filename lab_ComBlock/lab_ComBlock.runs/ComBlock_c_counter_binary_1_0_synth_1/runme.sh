...
HD_PWD='/scratch/smr3765/labs/lab_ComBlock/lab_ComBlock.runs/ComBlock_c_counter_binary_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ComBlock_c_counter_binary_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ComBlock_c_counter_binary_1_0.tcl
