...
HD_PWD='/scratch/smr3765/labs/lab_ComBlock/lab_ComBlock.runs/ComBlock_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ComBlock_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ComBlock_rst_ps7_0_100M_0.tcl
