...
HD_PWD='/scratch/smr3765/labs/lab_ComBlock/lab_ComBlock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ComBlock_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ComBlock_wrapper.tcl
