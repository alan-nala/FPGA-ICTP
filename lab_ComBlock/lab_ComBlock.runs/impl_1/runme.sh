...
HD_PWD='/scratch/smr3765/labs/lab_ComBlock/lab_ComBlock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ComBlock_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ComBlock_wrapper.tcl -notrace
