...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /scratch/Xilinx/Vitis_HLS/2022.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /scratch/Xilinx/Vitis_HLS/2022.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /scratch/Xilinx/Vitis_HLS/2022.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /scratch/Xilinx/Vitis_HLS/2022.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) $::env(LD_LIBRARY_PATH):/usr/lib/x86_64-linux-gnu
set ::env(LD_LIBRARY_PATH) /scratch/Xilinx/Vitis_HLS/2022.1/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "yuv_filter.autotvin.dat"
	set constFileTvOut       "yuv_filter.autotvout.dat"
	set constFileHdlTvIn     "yuv_filter.autohdltvin.dat"
	set constFileHdlTvOut    "yuv_filter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
