...
if {[file isfile yuv_filter.autotvin.dat]} {
	file delete -force yuv_filter.autotvin.dat
}

if {[file isfile yuv_filter.autotvout.dat]} {
	file delete -force yuv_filter.autotvout.dat
}
