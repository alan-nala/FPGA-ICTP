...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.yuv_filter.autotvin_in_channels_ch1.dat"
         "c.yuv_filter.autotvin_in_channels_ch2.dat"
         "c.yuv_filter.autotvin_in_channels_ch3.dat"
         "c.yuv_filter.autotvin_in_width.dat"
         "c.yuv_filter.autotvin_in_height.dat"
         "c.yuv_filter.autotvin_out_channels_ch1.dat"
         "c.yuv_filter.autotvin_out_channels_ch2.dat"
         "c.yuv_filter.autotvin_out_channels_ch3.dat"
         "c.yuv_filter.autotvin_Y_scale.dat"
         "c.yuv_filter.autotvin_U_scale.dat"
         "c.yuv_filter.autotvin_V_scale.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.yuv_filter.autotvout_out_channels_ch1.dat"
         "rtl.yuv_filter.autotvout_out_channels_ch2.dat"
         "rtl.yuv_filter.autotvout_out_channels_ch3.dat"
         "rtl.yuv_filter.autotvout_out_width.dat"
         "rtl.yuv_filter.autotvout_out_height.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
