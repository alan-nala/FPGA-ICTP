...
// ==============================================================
# 1 "/scratch/smr3765/Labs/HLS_Lab/yuv_filter/yuv_filter.c"
# 1 "/scratch/smr3765/Labs/HLS_Lab/yuv_filter/yuv_filter.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/scratch/smr3765/Labs/HLS_Lab/yuv_filter/yuv_filter.c" 2
...
# 2 "/scratch/smr3765/Labs/HLS_Lab/yuv_filter/yuv_filter.c" 2
...
# 3 "/scratch/smr3765/Labs/HLS_Lab/yuv_filter/yuv_filter.c" 2
...
extern "C"
#endif
void apatb_yuv_filter_ir(image_t *, image_t *, unsigned char, unsigned char, unsigned char);
#ifdef __cplusplus
extern "C"
#endif
void yuv_filter_hw_stub(image_t *in, image_t *out, unsigned char Y_scale, unsigned char U_scale, unsigned char V_scale){
yuv_filter(in, out, Y_scale, U_scale, V_scale);
return ;
}
#ifdef __cplusplus
extern "C"
#endif
void apatb_yuv_filter_sw(image_t *in, image_t *out, unsigned char Y_scale, unsigned char U_scale, unsigned char V_scale){
apatb_yuv_filter_ir(in, out, Y_scale, U_scale, V_scale);
return ;
}
#endif
# 28 "/scratch/smr3765/Labs/HLS_Lab/yuv_filter/yuv_filter.c"
