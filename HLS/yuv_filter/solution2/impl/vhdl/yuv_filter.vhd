...
architecture behav of yuv_filter is 
    ...
    "yuv_filter_yuv_filter,hls_ip_2022_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.960500,HLS_SYN_LAT=4708554,HLS_SYN_TPT=none,HLS_SYN_MEM=12288,HLS_SYN_DSP=0,HLS_SYN_FF=942,HLS_SYN_LUT=1680,HLS_VERSION=2022_1}";
