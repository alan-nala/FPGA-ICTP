...
HD_PWD='/scratch/smr3765/labs/lab_freeRTOS/lab_freeRTOS.runs/lab_freeRTOS_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_freeRTOS_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab_freeRTOS_axi_gpio_0_0.tcl
