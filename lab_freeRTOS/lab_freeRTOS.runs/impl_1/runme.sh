...
HD_PWD='/scratch/smr3765/labs/lab_freeRTOS/lab_freeRTOS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_freeRTOS_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_freeRTOS_wrapper.tcl -notrace
