...
HD_PWD='/scratch/smr3765/labs/lab_freeRTOS/lab_freeRTOS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_freeRTOS_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab_freeRTOS_wrapper.tcl
