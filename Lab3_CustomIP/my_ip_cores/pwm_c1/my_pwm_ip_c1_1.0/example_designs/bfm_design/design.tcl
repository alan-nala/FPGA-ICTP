proc create_ipi_design { offsetfile design_name } {
	...
	set my_pwm_ip_c1_0 [ create_bd_cell -type ip -vlnv user.org:user:my_pwm_ip_c1:1.0 my_pwm_ip_c1_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:my_pwm_ip_c1:1.0]]]]
