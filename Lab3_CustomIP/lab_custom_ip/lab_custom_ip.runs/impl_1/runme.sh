...
HD_PWD='/scratch/smr3765/labs/Lab3_PWM_Simulation/lab_custom_ip/lab_custom_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_custom_ip_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_custom_ip_wrapper.tcl -notrace
