...
HD_PWD='/scratch/smr3765/labs/Lab3_PWM_Simulation/lab_custom_ip/lab_custom_ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_custom_ip_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab_custom_ip_wrapper.tcl
