...
HD_PWD='/scratch/smr3765/labs/lab_irq/lab_irq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_irq_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_irq_wrapper.tcl -notrace
