...
HD_PWD='/scratch/smr3765/labs/lab_irq/lab_irq.runs/lab_irq_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_irq_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab_irq_xbar_0.tcl
