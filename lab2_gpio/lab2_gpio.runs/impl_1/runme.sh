...
HD_PWD='/scratch/smr3765/labs/lab2_gpio/lab2_gpio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_gpio_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab2_gpio_wrapper.tcl -notrace
