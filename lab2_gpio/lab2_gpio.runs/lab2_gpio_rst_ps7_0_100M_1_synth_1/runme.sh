...
HD_PWD='/scratch/smr3765/labs/lab2_gpio/lab2_gpio.runs/lab2_gpio_rst_ps7_0_100M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_gpio_rst_ps7_0_100M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab2_gpio_rst_ps7_0_100M_1.tcl
