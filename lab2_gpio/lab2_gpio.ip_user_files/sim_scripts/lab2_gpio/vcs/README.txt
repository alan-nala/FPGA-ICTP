...
#
# Generated by export_simulation on Thu Nov 17 17:45:14 CET 2022
#
################################################################################
...
'-reset_run' switch to the './lab2_gpio.sh' script.

./lab2_gpio.sh -reset_run
...
./lab2_gpio.sh -noclean_files

For more information on the script, please type './lab2_gpio.sh -help'.
