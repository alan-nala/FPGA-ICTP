...
HD_PWD='/scratch/smr3765/labs/lab_dma_simple/lab_dma_simple.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_dma_simple_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_dma_simple_wrapper.tcl -notrace
