...
HD_PWD='/scratch/smr3765/labs/lab_dma_simple/lab_dma_simple.runs/lab_dma_simple_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_dma_simple_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab_dma_simple_auto_pc_1.tcl
